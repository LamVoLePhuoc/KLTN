...
HD_PWD='C:/Users/Admin/Risc_V/Risc_V.runs/RV32IMFA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32IMFA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32IMFA.tcl
