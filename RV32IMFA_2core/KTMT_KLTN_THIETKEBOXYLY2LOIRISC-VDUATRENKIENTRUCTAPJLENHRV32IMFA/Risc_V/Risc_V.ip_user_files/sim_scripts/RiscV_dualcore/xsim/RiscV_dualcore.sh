...
#
# Script generated by Vivado on Tue May 05 00:22:54 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RiscV_dualcore.sh
...
#
# Usage        : RiscV_dualcore.sh
#                RiscV_dualcore.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RiscV_dualcore.sh [-rerun]
#                RiscV_dualcore.sh [-reset_run]
#                RiscV_dualcore.sh [-clean]
#                RiscV_dualcore.sh [-reset_log]
#                RiscV_dualcore.sh [-help]
#
...
# script info
echo -e "RiscV_dualcore.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RiscV_dualcore.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_bram_ctrl_v4_1_13 -L blk_mem_gen_v8_4_12 -L proc_sys_reset_v5_0_17 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L fifo_generator_v13_2_14 -L axi_data_fifo_v2_1_36 -L axi_crossbar_v2_1_38 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RiscV_dualcore xil_defaultlib.RiscV_dualcore xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RiscV_dualcore -key {Behavioral:sim_1:Functional:RiscV_dualcore} -tclbatch cmd.tcl -protoinst "protoinst_files/RiscV_dualcore.protoinst" -protoinst "protoinst_files/RV32IMFA_DualCore.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RiscV_dualcore.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RiscV_dualcore.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RiscV_dualcore.sh [-help]\n\
Usage: RiscV_dualcore.sh [-step]\n\
Usage: RiscV_dualcore.sh [-lib_map_path]\n\
Usage: RiscV_dualcore.sh [-rerun]\n\
Usage: RiscV_dualcore.sh [-reset_run]\n\
Usage: RiscV_dualcore.sh [-clean]\n\
Usage: RiscV_dualcore.sh [-reset_log]\n\
Usage: RiscV_dualcore.sh [-keep_index]\n\
Usage: RiscV_dualcore.sh [-noclean_files]\n\n\
