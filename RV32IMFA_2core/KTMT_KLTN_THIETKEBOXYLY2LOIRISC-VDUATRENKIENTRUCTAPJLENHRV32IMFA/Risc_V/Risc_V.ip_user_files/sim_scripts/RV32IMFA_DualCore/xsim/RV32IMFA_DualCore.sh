...
#
# Script generated by Vivado on Tue May 05 00:35:03 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RV32IMFA_DualCore.sh
...
#
# Usage        : RV32IMFA_DualCore.sh
#                RV32IMFA_DualCore.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RV32IMFA_DualCore.sh [-rerun]
#                RV32IMFA_DualCore.sh [-reset_run]
#                RV32IMFA_DualCore.sh [-clean]
#                RV32IMFA_DualCore.sh [-reset_log]
#                RV32IMFA_DualCore.sh [-help]
#
...
# script info
echo -e "RV32IMFA_DualCore.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RV32IMFA_DualCore.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RV32IMFA_DualCore xil_defaultlib.RV32IMFA_DualCore xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RV32IMFA_DualCore -key {Behavioral:sim_1:Functional:RV32IMFA_DualCore} -tclbatch cmd.tcl -protoinst "protoinst_files/RiscV_dualcore.protoinst" -protoinst "protoinst_files/RV32IMFA_DualCore.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RV32IMFA_DualCore.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RV32IMFA_DualCore.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RV32IMFA_DualCore.sh [-help]\n\
Usage: RV32IMFA_DualCore.sh [-step]\n\
Usage: RV32IMFA_DualCore.sh [-lib_map_path]\n\
Usage: RV32IMFA_DualCore.sh [-rerun]\n\
Usage: RV32IMFA_DualCore.sh [-reset_run]\n\
Usage: RV32IMFA_DualCore.sh [-clean]\n\
Usage: RV32IMFA_DualCore.sh [-reset_log]\n\
Usage: RV32IMFA_DualCore.sh [-keep_index]\n\
Usage: RV32IMFA_DualCore.sh [-noclean_files]\n\n\
