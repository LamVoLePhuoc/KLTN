module I_Cache (
    ...
    TagArray i_tag_array (
        ...
        // Phase-2: instruction memory is never written by another core in
        // this design, so the coherence snoop port is simply tied off.
        .snoop_en(1'b0), .snoop_index(5'b0), .snoop_tag(22'b0)
    );
    ...
    I_CacheController i_cache_ctrl (
